...
import com.opsifijobagent.common.response.ApiErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleMethodArgumentTypeMismatchException(
        ...
        return buildResponse(HttpStatus.BAD_REQUEST, "Invalid request parameter: " + exception.getName(), request, null);
    }
